...
model_folder = "3_fsr_2_optic_1_imu/model_parameters"  # Folder containing trained models (.h5)
...
prediction_path = os.path.join(current_directory, "3_fsr_2_optic_1_imu/predicted_data", prediction_file_name)
